...
Route::middleware('chatwoot.auth')->group(function () {
    ...
    Route::get('/v2/accounts/{account}/reports/{type}', [ReportController::class, 'csv']);
    Route::get('/v2/accounts/{account}/summary_reports/{type}', [ReportController::class, 'groupedSummary']);
    Route::get('/v2/accounts/{account}/live_reports/conversation_metrics', [ReportController::class, 'live']);
    Route::get('/v2/accounts/{account}/live_reports/grouped_conversation_metrics', [ReportController::class, 'groupedLive']);
});
