...
| Field | Value |
| --- | --- |
| Current phase | Realtime, storage and widget |
| Completed roadmap work | PRs 001-020: realtime transport complete |
| In progress | PR 021 attachments and storage |
| Completion on `main` | 64% |
| Completion after this PR | 67% |
